...
function Speaking() {
  ...
  const bullets = t('speaking.bullets', { returnObjects: true });

  return (
    <section id="speaking" className="space-y-8 py-20 lg:py-32">
      <motion.div
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold uppercase tracking-widest text-gold-500">
              {t('header.nav.speaking')}
            </span>
          </div>
          <h2 className="text-4xl font-semibold lg:text-5xl">{t('speaking.title')}</h2>
        </motion.div>
